...
# This file is duplicated from Airflow's "airflow/hooks/S3_hook.py" with one
# minor change because we want get_wildcard_key(...) to NOT match against
# paths ending in a slash (i.e., "directories").
...
class AstroS3Hook(BaseHook):
    ...
    def get_wildcard_key(self, wildcard_key, bucket_name=None, delimiter=''):
        ...
        # prevent remove "directories" from returning in results as we only
        # want to match files (not an empty top-level dir)
